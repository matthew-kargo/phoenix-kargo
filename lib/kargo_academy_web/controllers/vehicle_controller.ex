defmodule KargoAcademyWeb.VehicleController do
  use KargoAcademyWeb, :controller

  alias KargoAcademy.Vehicles
  alias KargoAcademy.Vehicles.Vehicle

  action_fallback KargoAcademyWeb.FallbackController
